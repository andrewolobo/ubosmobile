...
public class Global {
    ...
    public static final String SERVER_IP = "http://192.168.1.30:8080/ubos";
    public static final String ENDPOINT_CATEGORIES = "http://192.168.1.30:8080/ubos/index_get_categories.php";
