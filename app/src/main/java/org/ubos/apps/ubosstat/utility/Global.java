...
public class Global {
    ...
    public static String ENDPOINT = "http://www.ubos.org/ubos_app";
    ...
    public static final String SERVER_IP = "http://www.ubos.org/ubos_app";
    public static final String ENDPOINT_CATEGORIES = "http://www.ubos.org/ubos_app/index_get_categories.php";
    public static final String DOWNLOAD_URL = "http://uboscensusp.azurewebsites.net//api/data/Export?id=1";
