...
public class Global {
    public static String ENDPOINT = "http://192.168.8.104/ubos_app";
    ...
    public static final String SERVER_IP = "http://192.168.8.104/ubos_app";
    public static final String ENDPOINT_CATEGORIES = "http://192.168.8.104/ubos_app/index_get_categories.php";
